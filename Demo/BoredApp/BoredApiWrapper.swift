...
class BoredApiWrapper: ObservableObject {
    ...
    func loadActicity(key: Int? = nil, type: BoredApi.ActivityType? = nil, participants: Int? = nil, price: BoredApi.ExactOrRange<Double>? = nil, accessibility: BoredApi.ExactOrRange<Int>? = nil) async throws -> BoredApi.Activity {
...
protocol DataProvider {
    func loadActicity(key: Int?, type: BoredApi.ActivityType?, participants: Int?, price: BoredApi.ExactOrRange<Double>?, accessibility: BoredApi.ExactOrRange<Int>?) async throws -> BoredApi.Activity
}
